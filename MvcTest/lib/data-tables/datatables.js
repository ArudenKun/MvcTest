 ...
 *   https://datatables.net/download/#bs5/dt-2.2.2/fh-4.0.1/r-3.0.4/sl-3.0.0
 *
 * Included libraries:
 *   DataTables 2.2.2, FixedHeader 4.0.1, Responsive 3.0.4, Select 3.0.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.2.2/fh-4.0.1/r-3.0.4/sl-3.0.0",
